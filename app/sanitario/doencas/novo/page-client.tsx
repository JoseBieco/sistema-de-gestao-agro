        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ex: Tristeza Parasitária" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Detalhes sobre a ocorrência" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                    ...
                    <FormField
                      ...
                      render={({ field: subField }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input placeholder="Ex: Aplicar via intramuscular" {...subField} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? "Salvando..." : <><Save className="w-4 h-4 mr-2"/> Salvar Protocolo</>}
            </Button>
          </div>
        </form>
      </Form>
              ...
              <FormField
                ...
                render={({ field: subField }) => (
                  <FormItem className="flex-1">
                    <FormControl>
                      <Input placeholder="Nome (Ex: Bezerro)" {...subField} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field: subField }) => (
                  <FormItem className="w-24">
                    <FormControl>
                      <Input type="number" step="0.01" placeholder="Qtd (Ex: 10)" {...subField} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
